...
CREATE TABLE IF NOT EXISTS `token` (
  ...
  `info` VARCHAR(255) NULL COMMENT 'custom additional data, JSON-encoded. also holds the optional denomination data. managed by token creator/owner.',
  `processing_info` VARCHAR(255) NULL COMMENT 'custom additional processing data, JSON-encoded. may be updated by server processes and by the cash processing side.',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `clearing` (
  ...
  `debitor_account` VARCHAR(256) NULL COMMENT 'debitor account information, arbitrary\nJSON data',
  `creditor_account` VARCHAR(256) NULL COMMENT 'creditor account information, arbitrary\nJSON data',
