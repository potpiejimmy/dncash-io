...
CREATE TABLE IF NOT EXISTS `clearing` (
  ...
  `debitor_account` VARCHAR(256) NOT NULL COMMENT 'debitor account information, arbitrary\nJSON data',
  `creditor_account` VARCHAR(256) NOT NULL COMMENT 'creditor account information, arbitrary\nJSON data',
